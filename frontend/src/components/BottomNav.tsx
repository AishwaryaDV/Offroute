...
export function BottomNav() {
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 z-20 flex items-end gap-2.5 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
      ...
      <button
        disabled
        className="flex h-[52px] w-[52px] shrink-0 items-center justify-center rounded-full bg-white/95 shadow-lg ring-1 ring-black/5 backdrop-blur-xl text-[#0f1d32]/25"
